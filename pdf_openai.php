...
<link rel="shortcut icon" href="/tradutor_ia2/inc/images/favicon.png" type="image/x-icon"/>
<head>
    <meta charset="utf-8">
    ...
    <title>Análise de Artigos com IA (gpt-4o-mini)</title>
</head>
    ...
    <div class="container">
        <main>
            <div class="container p-5 rounded mt-5">
                <h1>Análise de Artigos com IA (gpt-4o-mini)</h1>
